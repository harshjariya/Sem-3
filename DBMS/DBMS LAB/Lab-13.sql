...
--5. Count the total number of villages in each citySELECT C.Name,COUNT(V.Name) FROM CITY AS C INNER JOIN VILLAGE AS V ON C.CityID=V.CityID GROUP BY C.Name

--6. Count the number of cities having more than one villag
